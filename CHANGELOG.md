...
qu'il est.
    ...
    aujourd'hui : beta 5.12.2 · sauvegarde v39 · 13 lignées illustrées sur 42 · 5 œufs sur 5
...
|---|---|
| **beta 5.12.2** | les recettes deviennent un **onglet secondaire de l'encyclopédie, en pleine page**, rangé par créature ; il n'existe qu'avec la pension, et le marchand ne vend plus de recette avant elle. La fiche perd ses onglets et ne liste plus de couples. **La forge s'ouvre avec la première poussière**, et non plus avec la première carte ; ouverte, elle le reste |
...
| **Les recettes dans l'encyclopédie** | beta 5.12.0 à 5.12.2 | sait-on comment faire naître une créature sans chercher dans deux écrans ? | oui — l'encyclopédie a un onglet *recettes*, en pleine page et rangé par créature : les couples qui la donnent, ses recettes apprises, et les recettes dont la créature reste inconnue. Il n'existe qu'avec la pension. La fiche ne liste plus de couples. On croyait que ça existait, ce qui était le meilleur argument. Le carnet des recettes, qui faisait doublon, s'y fond en `5.12.1` |
...
- **Un onglet, qui garde la structure de la ferme.** La pension prend l'onglet qui suit la
  ...
  depuis la ferme.
- **Un clic vaut un vingtième de la force du clic** (`CLIC_PENSION`, dans `constantes.js`), combo
  et frénésie comprises, sans plafond. Un clic entier bouclait, en fin de partie (400 s), une
  ponte d'une heure en neuf coups — une merveille toutes les deux minutes de clic au lieu d'une
  toutes les cinquante heures. Au vingtième, à quatre clics par seconde : ×5 à ×21 en milieu de
  partie, ×81 en fin de partie, une merveille toutes les 37 minutes de clic. **La `5.10.0`
  plafonnait plutôt la main à la moitié d'une ponte** : les clics d'après ne servaient à rien, et
  Maxime a préféré un clic plus faible à un clic qui s'arrête (`5.10.2`).
- **La carte ocellée clique l'onglet ouvert**, contrairement au garde-fou prévu plus haut : le
  couple sur la pension, la ferme partout ailleurs. Au vingtième, elle va au plus ×31.
